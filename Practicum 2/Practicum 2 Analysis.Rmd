...
Our first task will be to screen the number of candidate genes to a manageable level. We start this process by considering the incidence of gene expression. We determine where a gene is expressed by any given cell line, regardless of the level of expression. From this, we identify 4 groups of genes.
