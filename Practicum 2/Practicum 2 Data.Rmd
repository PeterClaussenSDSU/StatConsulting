...
A final approach to dimension reduction is to use principal component analysis to indentify pseudovariables that capture variation in gene expression patterns. We present a PCA of the most commonly expressed genes identified in the previous step. PCA may be computionally intractable for the full data set.
