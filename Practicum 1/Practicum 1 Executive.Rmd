...
------|--------------------|----------------
 ...
 5a | gender + age + shift + vig.ex.time + mod.ex.time + walk.ex.time + initial BMI | Initial BMI is close to having a significant affect on weight gain with a p-value of just over 0.5
 5b | gender + age + height + shift + vig.ex.time + mod.ex.time + walk.ex.time + initial body weight | Initial body weight is close to having a significant affect on weight gain with a p-value of just over 0.5 in the original generalized linear model 
