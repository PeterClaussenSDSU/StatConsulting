...
```{r}
metrics.dat$WG <- FALSE
metrics.dat$WG[metrics.dat$weightgain=='Yes'] <- TRUE
SA1.model1 <- glm(WG ~ Total_Met_Min, data=metrics.dat,family = binomial)
summary(SA1.model1)
SA1.model2 <- glm(WG ~ gender + Age + height + initial_BMI + shift + Total_Met_Min, data=metrics.dat,family = binomial)
summary(SA1.model2)
SA1.model3 <- glm(WG ~ gender + Age + height + initial_BMI + shift + Vig.ex.Time  + Mod.ex.time + Walk.ex.Time, data=metrics.dat, family = binomial)
summary(SA1.model3)

library(MASS)
best.model <- stepAIC(SA1.model3, direction = "both")
summary(best.model)
```


```{r}
metrics.dat$LBS <- round(metrics.dat$pounds_gained)
SA1.model1 <- glm(LBS ~ Total_Met_Min, data=metrics.dat,family = poisson)
summary(SA1.model1)
SA1.model2 <- glm(LBS ~ gender + Age + height+ initial_BMI + shift + Total_Met_Min, data=metrics.dat,family = poisson)
summary(SA1.model2)
SA1.model3 <- glm(LBS ~ gender + Age + height+ initial_BMI + shift + Vig.ex.Time  + Mod.ex.time + Walk.ex.Time, data=metrics.dat, family = poisson)
summary(SA1.model3)
...
```{r}
SA1.model1 <- glm(pounds_gained ~ Total_Met_Min, data=metrics.dat,family = gaussian)
summary(SA1.model1)
SA1.model2 <- glm(pounds_gained ~ gender + Age + height+ initial_BMI + shift + Total_Met_Min, data=metrics.dat,family = gaussian)
summary(SA1.model2)
SA1.model3 <- glm(pounds_gained ~ gender + Age + height+ initial_BMI + shift + Vig.ex.Time  + Mod.ex.time + Walk.ex.Time, data=metrics.dat, family = gaussian)
summary(SA1.model3)
...
plot(best.model)
par(mfrow=c(1,1))
hist(metrics.dat$pounds_gained)
```
...
summary(m1 <- zeroinfl(LBS ~ Total_Met_Min, data = metrics.dat))
summary(m2 <- zeroinfl(LBS ~ gender + Age + height+ initial_BMI + shift + Total_Met_Min, data = metrics.dat))
summary(m3 <- zeroinfl(LBS ~ gender + Age + height+ initial_BMI + shift + Vig.ex.Time + Mod.ex.time + Walk.ex.Time, data = metrics.dat))
```
