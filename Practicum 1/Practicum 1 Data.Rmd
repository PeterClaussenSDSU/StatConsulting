...
Add description for this calculation and plot
```{r, echo=TRUE}
...
```{r}
par(mfrow=c(1,2))
plot(metrics.dat$beginning_BMI,metrics.dat$lbs_gained)
...
We have proposed three response variables of interest as surrogates for weight gain, specifically `weightgain`, `pounds_gained`,and `beginning_BMI`.
