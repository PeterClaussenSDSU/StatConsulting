...
The following histograms aim to see if there are any apparent relationships between gender and BMI gain in this dataset. It appears there is a difference in histogram shapes for female beginning BMI and female final BMI. If BMI is chosen to be the response variable, these variables will be looked at more closely to determine if there is a positive/negative relationship.
```{r, echo=TRUE}
